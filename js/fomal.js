...
$.ajax({
  ...
  data: {
    key: 'K35BZ-2ZY3J-R7MFZ-DTVB3-YGBP2-GZFZU',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(113.744999, 23.048781, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
    ...
    debounce(function () {
      new Vue({
        data: function () {
          this.$notify({
            title: "你已被发现",
            message: "AKAS渡鸦重工提醒您，请自觉遵守GPL协议",
            position: 'top-left',
            offset: 50,
            showClose: true,
            type: "warning",
...
function createtime1() {
  var grt = new Date("27/03/2023 00:00:00"); //此处修改你的建站时间或者网站上线时间
  now1.setTime(now1.getTime() + 250);
  var days = (now1 - grt) / 1000 / 60 / 60 / 24;
  var dnum = Math.floor(days);

  var ascll = [
    `欢迎来到AKAS-鸦鸦的ai咒术模板小站`,
    `Future is now`,
    `
        
    _____   ____  __.  _____    _________         ____  ___.___   _____   ________    ___ ___    _____    _______   
    /  _  \ |    |/ _| /  _  \  /   _____/         \   \/  /|   | /  _  \  \_____  \  /   |   \  /  _  \   \      \  
   /  /_\  \|      <  /  /_\  \ \_____  \   ______  \     / |   |/  /_\  \  /   |   \/    ~    \/  /_\  \  /   |   \ 
  /    |    \    |  \/    |    \/        \ /_____/  /     \ |   /    |    \/    |    \    Y    /    |    \/    |    \
  \____|__  /____|__ \____|__  /_______  /         /___/\  \|___\____|__  /\_______  /\___|_  /\____|__  /\____|__  /
          \/        \/       \/        \/                \_/            \/         \/       \/         \/         \/ 
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by AKAS-XIAOHAN %c 你正在访问AKAS渡鸦重工内部数据",
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://s1.ax1x.com/2023/03/31/ppR5OzV.png);
    --darkmode-bg:url(https://s1.ax1x.com/2023/03/31/ppR5qGq.jpg);
    --mobileday-bg: url(https://s1.ax1x.com/2023/03/31/ppR5LR0.png);
    --mobilenight-bg: url(https://s1.ax1x.com/2023/03/31/ppR57Is.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
